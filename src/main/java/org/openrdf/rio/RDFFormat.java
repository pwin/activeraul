...
public class RDFFormat extends FileFormat {
	...
	public static final RDFFormat RDFXML = new RDFFormat("RDF/XML", Arrays
			...
			.forName("UTF-8"), Arrays.asList("rdf", "rdfs", "owl", "xml"), true,
			false);
	...
	public static final RDFFormat TURTLE = new RDFFormat("Turtle",
			"application/x-turtle", Charset.forName("UTF-8"), "ttl", true, false);

	/**
	 * The N3/Notation3 file format.
	 */
	public static final RDFFormat N3 = new RDFFormat("N3", "text/rdf+n3", Charset
			.forName("UTF-8"), "n3", true, false);

	/**
	 * The TriX file format.
	 */
	public static final RDFFormat TRIX = new RDFFormat("TriX",
			"application/trix", Charset.forName("UTF-8"), Arrays
					.asList("xml", "trix"), false, true);
	...
	//
	// Added by Florian Rosenberg
	//
	
	public static final RDFFormat RDFA = new RDFFormat("RDFa",
			"application/xhtml+xml", Charset.forName("UTF-8"), "xhtml", false, false);
	
	public static final RDFFormat RDFJSON = new RDFFormat("RDF/JSON",
			"application/json+rdf", Charset.forName("UTF-8"), "json", false, false);
	 ...
	 * @param mimeType The MIME type of the RDF file format, e.g.
	 *        <tt>application/rdf+xml</tt> for the RDF/XML file format.
	 * @param fileExt The (default) file extension for the RDF file format, e.g.
	...
	/**
	 * Tries to determine the appropriate RDF file format based on the a MIME type
	...
	/**
	 * Tries to determine the appropriate RDF file format based on the extension
	 * of a file name. The supplied fallback format will be returned when the file
	 * name extension was not recognized.
	 * @param fileName A file name.
	 ...
	 * @param formatName A format name.
	 ...
	 * @param mimeType The MIME type of the RDF file format, e.g.
	 *        <tt>application/rdf+xml</tt> for the RDF/XML file format.
	 * @param charset The default character encoding of the RDF file format.
	 *        Specify <tt>null</tt> if not applicable.
	 * @param fileExtension The (default) file extension for the RDF file format,
	 *        e.g. <tt>rdf</tt> for RDF/XML files.
	 */
	public RDFFormat(String name, String mimeType, Charset charset,
			String fileExtension, boolean supportsNamespaces, boolean supportsContexts) {
	 ...
	 * @param charset The default character encoding of the RDF file format.
	 *        Specify <tt>null</tt> if not applicable.
	 * @param fileExtensions The RDF format's file extensions, e.g. <tt>rdf</tt>
	 *        for RDF/XML files. The first item in the list is interpreted as the
	 ...
	 * Creates a new RDFFormat object.
	 * @param name The name of the RDF file format, e.g. "RDF/XML".
	 * @param mimeTypes The MIME types of the RDF file format, e.g.
